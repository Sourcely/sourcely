//expecting obj with the following format
// {
//   source: "sourceName",
//   title: "title",
//   link: "the url",
//   abstract: "the abstract",
//   keywords: ["pesticides", "bedbugs"],
//   visits: "visit count or null",
//   categories: [empty if not indicated in api, if we know the category/section then strings in an array"],
//   published_date: "the date it was published",
//   media: [{type: "image", url: "the url"}] //empty array if no media,
//   thumbnail: null or a string
// }
...
var categoryChecker = function (articleObj) {
  if(articleObj.categories.length > 0) {
    var title = articleObj.title.toLowerCase();
    var titleKeyWords = title.removeStopWords();
...
//
var eventChecker = function(articleObj) {
